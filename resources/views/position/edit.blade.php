    ...
    <div class="container-fluid container-fixed-lg">
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="panel-title">Ubah Jabatan</div>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-12">
                        <form method="post" action="{{ route('position.update', $position->id) }}" class="form-horizontal" role="form" autocomplete="off">
                            @csrf
                            @method('patch')
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <select name="type" class="form-control" required="">
                                        ...
                                        <option value="Struktural" @if ($position->type == "Struktural") selected @endif>Struktural</option>
                                        <option value="Fungsional" @if ($position->type == "Fungsional") selected @endif>Fungsional</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="order" value="{{ $position->order }}" required>
                                </div>
                            </div>
                            <br>
                            <div class="row">
